...
const KepalaPerpustakaanKonfirmasiDetailRepositori = ({ data }) => {
  ...
  const handleAccept = async () => {
    ...
    try {
      ...
      router.push('/kepala-perpustakaan/repositori/konfirmasi');
    } catch (error) {
    } finally {
      setLoading(false);
    }
...
export default KepalaPerpustakaanKonfirmasiDetailRepositori;
