...
const KepalaPerpustakaanDashboard = ({ data }) => {
  const [items, setItems] = useState([
    {
      label: 'Total pemustaka',
      value: 0,
      link: '/kepala-perpustakaan/pemustaka',
    },
    {
      label: 'Total repositori',
      value: 0,
      link: '/kepala-perpustakaan/repositori',
    },
    {
      label: 'Total permintaan akses pending',
      value: 0,
      link: '/kepala-perpustakaan/permintaan-akses',
    },
  ]);
    ...
    try {
      ...
      setItems([
        ...
        },
        {
          ...
          link: '/kepala-perpustakaan/dashboard',
        },
      ]);
    } catch (error) {
    } finally {
...
export default KepalaPerpustakaanDashboard;
