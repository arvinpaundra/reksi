...
const AdministratorRepositori = ({ data }) => {
  ...
  return (
    <>
              ...
              <div className="flex flex-col gap-4 xl:col-span-9">
                ...
                {totalPendingRepositories > 0 && (
                  <Card className="w-full bg-blue/5 border border-blue rounded-lg overflow-hidden h-fit">
                    <Link href="/administrator/repositori/konfirmasi">
                    ...
                    {repositories?.length > 0 ? (
                      repositories?.map((item) => (
                        <div className="relative" key={item.id}>
                          <Link href={`/administrator/repositori/${item.id}`} key={item.id}>
                            <a>
      ...
      <AddRepoModal isOpen={isOpenModal} setIsOpenModal={setIsOpenModal} />
...
export default AdministratorRepositori;

const AddRepoModal = ({ isOpen, setIsOpenModal }) => {
  return (
            ...
            >
              <Dialog.Panel className="w-full max-w-xl transform overflow-hidden rounded-lg bg-white shadow-xl transition-all">
                ...
                <CardBody className="p-4 grid grid-cols-12 grid-rows-2 gap-4">
                  <Link href="/administrator/repositori/tambah/tugas-akhir">
                  ...
                  <Link href="/administrator/repositori/tambah/magang-industri">
                    <a className="h-40 col-span-12 md:col-span-6 p-2 md:p-4 flex flex-col items-center justify-center hover:bg-black/5 border border-black/50 rounded-md">
                      <FaBook size={24} className="mb-4" />
                  ...
                  <Link href="/administrator/repositori/tambah/penelitian">
