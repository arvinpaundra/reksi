...
import CardInternshipReport from '../../../../components/organisms/CardInternshipReport';
import Footer from '../../../../components/organisms/Footer';
import Navbar from '../../../../components/organisms/Navbar';
import Sidebar from '../../../../components/organisms/Sidebar';

const InternshipReport = (props) => {
  const { data } = props;

  return (
    <div>
      <Head>
        <title>Unggah Laporan Magang Industri</title>
      </Head>
      ...
      <div className="w-full min-h-screen">
        ...
        <main className="px-4 md:px-12 lg:px-24 mt-6 mb-20 lg:my-6 2xl:px-[15%] xl:grid xl:grid-cols-12 xl:gap-4">
          ...
          <CardInternshipReport user={data} />
        </main>
