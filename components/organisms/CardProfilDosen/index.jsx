            ...
            {enableEdit ? (
              <>
                <Input
                  ...
                  onChange={(event) => setPemustaka({ ...pemustaka, name: event.target.value })}
          ...
          <div className="w-full flex flex-col items-center justify-center md:grid md:grid-cols-12 gap-4">
            <div className="flex flex-col gap-1 w-full md:col-span-6">
              ...
              {enableEdit ? (
                ...
                <p>{!pemustaka.birth_date?.length ? 'Belum diisi' : pemustaka.birth_date}</p>
              )}
            </div>
            <div className="flex flex-col gap-1 w-full md:col-span-6">
              <label
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col items-center justify-center md:grid md:grid-cols-12 gap-4">
            ...
            >
              ...
              >
                NIDN {enableEdit && <ImportantField />}
              </label>
              {enableEdit ? (
                <>
                  <Input
...
export default CardProfilDosen;
